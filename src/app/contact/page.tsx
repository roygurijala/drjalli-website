...
import { MAPS_DIRECTIONS_URL, PRACTICE_NAME } from "@/lib/constants";
  ...
  return (
    <>
      <InnerPageHero
        ...
        description="Please call the office for appointments, scheduling changes, and medical questions. For emergencies or urgent symptoms, call 911 or go to the nearest emergency department."
        ...
        <main className="mx-auto max-w-6xl px-4 pt-8 md:pt-10">
          <section className="mb-10 grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-xs">
                <a
                  href={`tel:${tel}`}
                  className="inline-flex items-center justify-center rounded-full bg-teal-500 px-5 py-2 font-semibold text-white shadow-md shadow-teal-500/20 hover:bg-teal-400"
                >
                  Call {PRACTICE_PHONE}
                </a>
                <a
            ...
            <div className="rounded-3xl border border-teal-200/60 bg-gradient-to-br from-teal-50/80 to-white p-5 text-xs text-slate-700 shadow-sm md:p-6">
              <h2 className="font-display text-sm font-bold uppercase tracking-wide text-slate-600">
                Helpful information
              </h2>
              <ul className="mt-3 space-y-2">
                <li>
                  ...
                  <span className="font-semibold">
                    chest pain, trouble breathing, severe symptoms, or
                    emergencies
                  </span>
                  , call 911 or go to the nearest emergency department.
                </li>
                <li>
                  • For medication refills, please reach out to your pharmacy
                  first. If you still need help, feel free to call our office
                  during business hours or use the patient portal.
                </li>
                <li>
          ...
          <section className="mb-12 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-8">
            <div className="mb-4 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
              <div>
                <h2 className="font-display text-lg font-bold tracking-tight text-slate-900 md:text-xl">
                  Location & directions
                </h2>
                <p className="mt-1 max-w-xl text-xs text-slate-700 md:text-sm">
                  Use the map below or scan the QR code to open directions on
                  your phone. You can also tap &quot;Open in Google Maps&quot; if
                  you are already on a mobile device.
                </p>
              </div>
            </div>

            <div className="grid gap-6 md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] md:items-stretch">
              <div className="overflow-hidden rounded-3xl border border-teal-200/60 bg-slate-50 shadow-sm">
                <iframe
                  src={mapsEmbed}
              ...
              <div className="flex flex-col justify-between gap-4 rounded-3xl border border-teal-100 bg-slate-50/80 p-5 shadow-sm">
                <div>
                ...
                <div className="text-[11px] text-slate-600 md:text-xs">
                  ...
                  <p className="mt-1">
                    ...
                    Suite 330. If you have questions about access, call the
                    office and our staff can assist you.
                  </p>
                </div>
              </div>
            </div>
